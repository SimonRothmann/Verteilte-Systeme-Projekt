 ...
 */
package dhbwka.wwi.vertsys.javaee.filmsortierung.common.ejb;
...
public class UserBean extends EntityBean<User, Long> {
     ...
     */
    public void signup(String forename, String surname, String username, String password) throws UserAlreadyExistsException {
        if (em.find(User.class, username) != null) {
            throw new UserAlreadyExistsException("Der Benutzername $B ist bereits vergeben.".replace("$B", username));
        }

        User user = new User(forename, surname, username, password);
